...
class CARFACGradientTest(tf.test.TestCase):
  ...
  def testGradients(self):
    ...
    for tfvar in [
        carfac_cell.car_params.velocity_scale,
        carfac_cell.car_params.v_offset,
        carfac_cell.car_params.min_zeta_at_half_erb_per_step,
        carfac_cell.car_params.max_zeta_at_half_erb_per_step,
        carfac_cell.car_params.zero_ratio,
        carfac_cell.car_params.high_f_damping_compression,
        carfac_cell.car_params.erb_break_freq,
        carfac_cell.car_params.erb_q,
        carfac_cell.ihc_params.tau_lpf,
        carfac_cell.ihc_params.tau1_out,
        carfac_cell.ihc_params.tau1_in,
        carfac_cell.ihc_params.tau2_out,
        carfac_cell.ihc_params.tau2_in,
        carfac_cell.ihc_params.ac_corner_hz,
        carfac_cell.agc_params.agc_stage_gain,
        carfac_cell.agc_params.agc_mix_coeff,
        carfac_cell.agc_params.time_constants0,
        carfac_cell.agc_params.time_constants_mul,
        carfac_cell.agc_params.agc1_scales0,
        carfac_cell.agc_params.agc1_scales_mul,
