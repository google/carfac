...
class CarfacTest(parameterized.TestCase):
  ...
  def test_whole_carfac(self, cap):
    ...
    max_expected_responses = {  # By channel, pre and post adaptation
        0: (9.487948409514502e-05, 9.490316690485422e-05),
        5: (0.00017297988233622164, 0.0001009863561634724),
        10: (0.0008493493078276515, 0.00034862821330432204),
        15: (0.002143998397514224, 0.0005339218932169718),
        20: (0.003477955237030983, 0.0005804563797094804),
        25: (0.0038766416255384684, 0.00037788400473154576),
        30: (0.003501462982967496, 0.00017979674960438017),
        35: (0.0025851549580693245, 0.00010001073979439131),
        40: (0.001656502252444625, 7.904709810180338e-05),
        45: (0.0009385987068526447, 0.00014752117215859),
        50: (0.0004409996035974473, 0.0002191631840270163),
        55: (0.00016036791203077883, 0.00012798002091157846),
        60: (4.511831502895802e-05, 4.1902346665000586e-05),
        65: (7.950785402499605e-06, 7.756562632698564e-06),
        70: (9.104484206545749e-07, 9.001856971912885e-07),
    }
    if not cap:
      # The following data comes from the Numpy implementation
      max_expected_responses = {  # By channel, pre and post adaptation
          0: (9.487948409514502e-05, 9.489925609401867e-05),
          5: (0.00017297988233622164, 0.00010649619775827624),
          10: (0.0008493493078276515, 0.00037537525820800934),
          15: (0.002143998397514224, 0.0006024741035230806),
          20: (0.003477955237030983, 0.0006455837421126551),
          25: (0.0038766416255384684, 0.0004230648461965363),
          30: (0.003501462982967496, 0.00019295698392581627),
          35: (0.0025851549580693245, 0.00010509460933118209),
          40: (0.001656502252444625, 8.079291836852494e-05),
          45: (0.0009385987068526447, 0.0001498181643465775),
          50: (0.0004409996035974473, 0.00022118189924241833),
          55: (0.00016036791203077883, 0.00012838535075233948),
          60: (4.511831502895802e-05, 4.197237331253983e-05),
          65: (7.950785402499605e-06, 7.760714267302595e-06),
          70: (9.104484206545749e-07, 9.004354107620812e-07),
      }
    ...
    if cap:
      results = {
          # The python test produces this block.
          125: [64, 118.944, 0.262189],
          250: [58, 239.771, 0.986817],
          500: [49, 514.607, 7.309967],
          1000: [38, 1099.436, 31.643596],
          2000: [28, 2038.875, 27.213682],
          4000: [16, 4058.881, 13.822844],
          8000: [2, 8289.882, 3.564846],
      }
    else:
      # The python test produces this block.
      results = {
          125: [64, 118.944, 0.256815],
          250: [58, 239.771, 0.963544],
          500: [49, 514.607, 7.224768],
          1000: [38, 1099.436, 31.372928],
          2000: [28, 2038.875, 26.243785],
          4000: [16, 4058.881, 12.725520],
          8000: [2, 8289.882, 3.212051],
      }
    ...
    for desired_cf in results:
      ...
      cf = initial_resps[expected_c][0]
      diff_db = initial_resps[expected_c][1] - final_resps[expected_c][1]
      print(f'{desired_cf}: [{int(c)}, {cf:.3f}, {diff_db:.6f}],')
